...
function App() {
  ...
  const checkServerHealth = async () => {
    console.log('Checking server health at:', `${config.apiUrl}/health`); // Debug log
    ...
    try {
      ...
      // Additional debugging - try direct fetch
      try {
        const directResponse = await fetch(`${config.apiUrl}/health`);
